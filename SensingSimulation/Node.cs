...
namespace SensingSimulation
{
    ...
    public abstract class Node
    {
        ...
        public Point Location
        {
            ...
            set { 
                mLocation = value;
                if (mLocation.X < -1000 || mLocation.Y < -1000)
                {
                    stop = true;
                }
            }
        ...
        {
            Pen thePen = (Pen)Pens.Gray.Clone();
            //thePen.CustomEndCap = new AdjustableArrowCap(3, 6, true);
            thePen.CustomEndCap = new AdjustableArrowCap(3, 6);
            //thePen.StartCap = 
            //thePen.CustomStartCap = new CustomLineCap(
            ...
            CustomLineCap theCap = new CustomLineCap(null, myPath);
            thePen.CustomStartCap = theCap;
                //myPath2);
            ...
            //graphics.DrawLine(thePen, from, to); // original code
            graphics.DrawLine(thePen, to, from);
        }
    ...
    /// Provides an example implementation of the Node class. SpotNode is an 8x8 circle that is stroked and filled.
    /// </summary>
    public class ENode : Node
    {
        ApplianceButton b = null;
        NodeConnection c = null;
        List<NodeConnection> mGradients = new List<NodeConnection>();	// list of references to connected nodes (children)
        ...
        /// Initalises a new instance of the SpotNode class using default values.
        /// </summary>
        public ENode() : this(null) { }

        /// <summary>
        /// Initalises a new instance of the SpotNode class using the specified fill color.
        /// </summary>
        /// <param name="color">The System.Drawing.Color to fill the spot with.</param>
        public ENode(ApplianceButton _b)
            : base()
        {
            b = _b;
        ...
        //public override void DrawConnector(Graphics graphics, Point from, Point to, Node other)
        //{
        //    base.DrawConnector(graphics, from, to, other);
            
            //foreach (NodeConnection c in this.mGradients)
            //{
            //    if ( c.MatchesProfile(Utilities.Helper.profile) )
            //    {
            //        base.DrawConnector(graphics, from, to, other);
            //    }
            //}
        ...
        public bool AddGradient(NodeConnection c)
        {
            this.mGradients.Add(c);
            AddChild(c.node2.applButton.eNode);
            return true;
